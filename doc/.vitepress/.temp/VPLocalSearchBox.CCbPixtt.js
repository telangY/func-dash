...
import { v as unrefElement, x as tryOnScopeDispose, y as computedAsync, z as useSessionStorage, A as useLocalStorage, B as watchDebounced, f as onKeyStroke, D as useRouter, F as useEventListener, k as useScrollLock, q as dataSymbol, p as pathToFile, G as escapeRegExp, j as inBrowser } from "./Content.CLzxZVqA.js";
import { u as useData, c as createSearchTranslate } from "./app.js";
import { _ as _export_sfc } from "./plugin-vue_export-helper.1tPrXgE0.js";
const localSearchIndex = { "root": () => import("./@localSearchIndexroot.BKo1bzKi.js") };
/*!
* tabbable 6.2.0
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderTeleport(_push, (_push2) => {
        var _a3, _b2, _c, _d;
        _push2(`<div role="button"${ssrRenderAttr("aria-owns", ((_a3 = results.value) == null ? void 0 : _a3.length) ? "localsearch-list" : void 0)} aria-expanded="true" aria-haspopup="listbox" aria-labelledby="localsearch-label" class="VPLocalSearchBox" data-v-9d784662><div class="backdrop" data-v-9d784662></div><div class="shell" data-v-9d784662><form class="search-bar" data-v-9d784662><label${ssrRenderAttr("title", buttonText.value)} id="localsearch-label" for="localsearch-input" data-v-9d784662><span aria-hidden="true" class="vpi-search search-icon local-search-icon" data-v-9d784662></span></label><div class="search-actions before" data-v-9d784662><button class="back-button"${ssrRenderAttr("title", unref(translate)("modal.backButtonTitle"))} data-v-9d784662><span class="vpi-arrow-left local-search-icon" data-v-9d784662></span></button></div><input${ssrRenderAttr("value", unref(filterText))}${ssrRenderAttr("placeholder", buttonText.value)} id="localsearch-input" aria-labelledby="localsearch-label" class="search-input" data-v-9d784662><div class="search-actions" data-v-9d784662>`);
        if (!disableDetailedView.value) {
          _push2(`<button type="button" class="${ssrRenderClass([{ "detailed-list": unref(showDetailedList) }, "toggle-layout-button"])}"${ssrRenderAttr("title", unref(translate)("modal.displayDetails"))} data-v-9d784662><span class="vpi-layout-list local-search-icon" data-v-9d784662></span></button>`);
        } else {
          _push2(`<!---->`);
        }
        _push2(`<button class="clear-button" type="reset"${ssrIncludeBooleanAttr(disableReset.value) ? " disabled" : ""}${ssrRenderAttr("title", unref(translate)("modal.resetButtonTitle"))} data-v-9d784662><span class="vpi-delete local-search-icon" data-v-9d784662></span></button></div></form><ul${ssrRenderAttr("id", ((_b2 = results.value) == null ? void 0 : _b2.length) ? "localsearch-list" : void 0)}${ssrRenderAttr("role", ((_c = results.value) == null ? void 0 : _c.length) ? "listbox" : void 0)}${ssrRenderAttr("aria-labelledby", ((_d = results.value) == null ? void 0 : _d.length) ? "localsearch-label" : void 0)} class="results" data-v-9d784662><!--[-->`);
        ssrRenderList(results.value, (p, index) => {
          _push2(`<li role="option"${ssrRenderAttr("aria-selected", selectedIndex.value === index ? "true" : "false")} data-v-9d784662><a${ssrRenderAttr("href", p.id)} class="${ssrRenderClass([{
            selected: selectedIndex.value === index
          }, "result"])}"${ssrRenderAttr("aria-label", [...p.titles, p.title].join(" > "))} data-v-9d784662><div data-v-9d784662><div class="titles" data-v-9d784662><span class="title-icon" data-v-9d784662>#</span><!--[-->`);
          ssrRenderList(p.titles, (t, index2) => {
            _push2(`<span class="title" data-v-9d784662><span class="text" data-v-9d784662>${t}</span><span class="vpi-chevron-right local-search-icon" data-v-9d784662></span></span>`);
          });
          _push2(`<!--]--><span class="title main" data-v-9d784662><span class="text" data-v-9d784662>${p.title}</span></span></div>`);
          if (unref(showDetailedList)) {
            _push2(`<div class="excerpt-wrapper" data-v-9d784662>`);
            if (p.text) {
              _push2(`<div class="excerpt" inert data-v-9d784662><div class="vp-doc" data-v-9d784662>${p.text}</div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="excerpt-gradient-bottom" data-v-9d784662></div><div class="excerpt-gradient-top" data-v-9d784662></div></div>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`</div></a></li>`);
        ...
        if (unref(filterText) && !results.value.length && enableNoResults.value) {
          _push2(`<li class="no-results" data-v-9d784662>${ssrInterpolate(unref(translate)("modal.noResultsText"))} &quot;<strong data-v-9d784662>${ssrInterpolate(unref(filterText))}</strong>&quot; </li>`);
        } else {
          _push2(`<!---->`);
        }
        _push2(`</ul><div class="search-keyboard-shortcuts" data-v-9d784662><span data-v-9d784662><kbd${ssrRenderAttr("aria-label", unref(translate)("modal.footer.navigateUpKeyAriaLabel"))} data-v-9d784662><span class="vpi-arrow-up navigate-icon" data-v-9d784662></span></kbd><kbd${ssrRenderAttr("aria-label", unref(translate)("modal.footer.navigateDownKeyAriaLabel"))} data-v-9d784662><span class="vpi-arrow-down navigate-icon" data-v-9d784662></span></kbd> ${ssrInterpolate(unref(translate)("modal.footer.navigateText"))}</span><span data-v-9d784662><kbd${ssrRenderAttr("aria-label", unref(translate)("modal.footer.selectKeyAriaLabel"))} data-v-9d784662><span class="vpi-corner-down-left navigate-icon" data-v-9d784662></span></kbd> ${ssrInterpolate(unref(translate)("modal.footer.selectText"))}</span><span data-v-9d784662><kbd${ssrRenderAttr("aria-label", unref(translate)("modal.footer.closeKeyAriaLabel"))} data-v-9d784662>esc</kbd> ${ssrInterpolate(unref(translate)("modal.footer.closeText"))}</span></div></div></div>`);
      }, "body", false, _parent);
    };
  }
});
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/vitepress@1.1.0_@algolia+client-search@4.23.3_postcss@8.4.38_search-insights@2.13.0_typescript@5.4.3/node_modules/vitepress/dist/client/theme-default/components/VPLocalSearchBox.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const VPLocalSearchBox = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9d784662"]]);
export {
